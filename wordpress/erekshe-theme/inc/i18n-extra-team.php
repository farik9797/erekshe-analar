...
add_filter('erekshe_tr_extra', function ($arr, $L) {
    $m = [
        'ru' => [
            ...
            'team_grp_vospitatel'      => 'Воспитатели',
            'team_grp_vospitatel_asst' => 'Помощники воспитателя',
            'team_grp_nanny'           => 'Нянечки',
        ...
        'kk' => [
            ...
            'team_grp_vospitatel'      => 'Тәрбиешілер',
            'team_grp_vospitatel_asst' => 'Тәрбиеші көмекшілері',
            'team_grp_nanny'           => 'Күтушілер',
